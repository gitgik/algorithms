...
- [Min number of squares adding to n](dynamic-programming/min_squares.md)
...
- [Grouping titles](hash-maps/group_titles.ipynb)
...
- [Remove all consecutive nodes that add to zero](linked-lists/print-remaining-nodes.md)
